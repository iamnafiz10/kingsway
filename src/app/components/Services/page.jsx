...
function Services() {
    ...
    return (
        <>
            <section id="services-section" className="relative" style={{ backgroundImage: `url(${ServicesBg.src})` }}>
                ...
                <div className="container py-[6rem] relative z-10">
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                        {service_list.map((item) => (
                            <div key={item.id} onClick={() => handleBoxClick(item.id)} className="col cursor-pointer">
                                <div className="relative group">
                                    <div className="box bg-white hover:bg-[#DBF5E4] h-full md:h-[320px] xl:h-[280px] py-4 pl-6 rounded">
                                        <div className="flex items-center justify-between">
                                            <Image src={item.service_Image} width={100} height={100}
                                                   className="w-14 group-hover:stock-white" alt="serviceOne"/>
                                            <div className="triangle-service bg-primary flex items-center justify-center h-[45px] w-[70px]">
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full border-b-8 border-transparent group-hover:border-primary transition-all duration-500"></div>
                                </div>
                            </div>
                        ))}
                    </div>
